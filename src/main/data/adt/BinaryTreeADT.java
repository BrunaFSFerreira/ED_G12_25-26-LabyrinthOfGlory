...
public interface BinaryTreeADT<T> {
    ...
    /**
     * Returns if this binary tree is empty and false otherwise
     ...
     * @return the integer number of elements in this binary tree
     */
    public int size();

    /**
     * Return true if the binary tree contains an element that matches the specified element and false otherwise
    ...
    /**
     * Performs an inorder traversal on this binary tree by calling an overloaded, recursive inorder method that start with the root
